...
public class TestFruits {
	...
	public void testAddFruits(String param) {//sunnyday -- developer's perspective
		boolean actualResult = fruits.addFruits(param);
		assertEquals(true, actualResult);
	}
	
	@RepeatedTest(10)
	public void testAddFruitsRainy() {//rainyday -- tester's perspective
	...
	public void testGetStandNotNull() {
		assertNotNull(fruits.getStand());//developer's perspective
	}
